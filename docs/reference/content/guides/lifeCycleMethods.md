...
- __@PrePersist__ - Called before save, it can return a __Document__ in place of an empty one.
- __@PostPersist__ - Called after the save call to the database
- __@PreLoad__ - Called before mapping the document from the database to the entity; the Document is passed as an argument (you can
