...
- __@PreLoad__ - Called before mapping the datastore object to the entity (POJO); the Document is passed as an argument (you can add/remove/change values)
- __@PostLoad__ - Called after mapping to the entity
- __@PrePersist__ - Called before save, it can return a Document in place of an empty one.
